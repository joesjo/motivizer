...
export default function PosterGenerator() {
  ...
  const savePoster = () => {
    ...
    localStorage.setItem(
      ...
      JSON.stringify([
        ...currentPosters,
        { id: Date.now(), quote: quote, image: image },
      ])
    );
    setSaved(true);
  };
    ...
    <>
      {loading ? (
        <img
          ...
          alt="Loading..."
          style={{ height: "20vh", marginTop: "20vh", marginBottom: "20vh" }}
        />
      ) : (
        <Poster
      ...
      <div className="button-container">
        <button onClick={() => savePoster()} disabled={saved}>
          {saved ? "✔️ Saved" : "Save Poster"}
        </button>
